These quarto files contain the necessary code required to replicate an analysis industry payments to neurologists caring for patients with multiple sclerosis (MS). 
